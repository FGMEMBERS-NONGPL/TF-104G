...
var init = func {
	 ...
	 timer.start();
	     ...
	     var max = 0.75; # Maximum volume when internal and door open
	     var min = 0.09; # Volume when internal and door closed (what makes it through the door)
	     var multiplier = 4; # How quickly volume reaches maximum as door opens
